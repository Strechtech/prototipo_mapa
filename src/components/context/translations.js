const translations = {
  es: {
    ...
    navbar: {
             // Opción de noticias en el navbar
  ...
  newLinesDescription4: "✔️ Desarrollo de metodologías escalables para pequeños y medianos productores.",
    ...
    // traduccion miembros del equió:
    teamMembers: {
      "Patrick Vandewalle": "Patrick Vandewalle es Profesor Asociado en KU Leuven, Bélgica, especializado en imagen computacional y visión artificial.",
      "Esteban Valencia": "Esteban Valencia, Ingeniero Mecánico de la EPN con Maestría en Aeroespacial y Doctorado en Potencia y Propulsión.",
      "Jackeline Abad": "Profesora Asociada en la EPN, tiene maestría y doctorado en Ingeniería Eléctrica de la Universidad Estatal de Washington.",
      /*"Carina Rosero": "Analista en el Ministerio de Producción de Ecuador desde 2021, con experiencia en salud y regulación sanitaria.",
      "Yadira Vargas": "Ingeniera Agropecuaria con 10 años de experiencia en investigación en frutales amazónicos.",
      "Hernan Rivadeneira": "Director de Agrocalidad en Morona Santiago y Profesional Técnico en el Ministerio de Agricultura, es Médico Veterinario Zootecnista.",*/
      "Jenny Ávila": "Jenny Ávila Vélez, Máster en Ciencia de los Alimentos, analiza pitahaya en granjas piloto, optimizando la gestión de cultivos.",
      "Cristina Romero": "Cristina Romero es PhD en Economía Agrícola y Desarrollo Rural y desde 2016 es docente en la Escuela Politécnica Nacional en Quito."/*,
      "Diana Navarro": "Diana supervisa y valida los sistemas de telecomunicaciones, incluyendo protocolos, hardware y arquitectura."*/
    },
    ...
    noticias: {
      ...
      readMore: "Leer más",           // Botón para leer más
      readLess: "Leer menos",         // Botón para leer menos
    },
    ...
    icons: {
      icon1: {
        title: "Icono de Agricultura",
        description: "Este icono representa la agricultura sostenible y las tecnologías aplicadas a la gestión agrícola."
      },
      icon2: {
        title: "Icono de Tecnología",
        description: "Este icono simboliza la innovación tecnológica que mejora la eficiencia en el sector agrícola."
      },
      icon3: {
        title: "Icono de Innovación",
        description: "Representa las innovaciones en el campo agrícola que permiten una mejor toma de decisiones y productividad."
      },
      icon4: {
  ...
  "Diana Navarro": "Diana supervises and validates telecommunication systems, including protocols, hardware, and architecture."*/
    ...
    icons: {
      icon1: {
        ...
        description: "This icon represents sustainable agriculture and technologies applied to agricultural management."
      },
      icon2: {
        title: "Technology Icon",
        description: "This icon symbolizes technological innovation that improves efficiency in the agricultural sector."
      },
      icon3: {
        title: "Innovation Icon",
        description: "Represents innovations in agriculture that enable better decision-making and productivity."
      },
      icon4: {
